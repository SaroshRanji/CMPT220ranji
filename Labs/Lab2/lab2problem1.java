...
public class lab2problem1 {
	...
	public static void main(String[] args) {
		...
		if(number1 != number2) {
			System.out.println(number1 + " not equal to " + number2 + " true");
		} else if(number1 == number2) {
				System.out.println(number1 + " is equal to " + number2 + " false");
		}
		...
		// Write a Java program that takes two numbers (number1 and number2) from the user and prints
		//the result of the following expressions. List all as true or false
